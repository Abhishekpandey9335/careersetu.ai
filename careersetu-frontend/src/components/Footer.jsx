    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <Link to="/" className="footer-logo">
              <div className="footer-logo-icon">Ai Rojgar</div>
              <div>
                <div className="footer-logo-name">Ai Rojgar</div>
            ...
            <div className="footer-social">
              <a href="https://www.instagram.com/airojgar.in/?hl=en" target="_blank" rel="noopener noreferrer" className="social-icon">
              ...
              <a href="https://www.youtube.com/@airojgarofficial" target="_blank" rel="noopener noreferrer" className="social-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          <p>© 2026 Ai Rojgar. All Rights Reserved.</p>
