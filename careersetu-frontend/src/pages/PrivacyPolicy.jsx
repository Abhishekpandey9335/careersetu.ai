  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '48px 20px', maxWidth: 860 }}>
        {[
          { title: '1. Introduction', content: 'Welcome to Ai Rojgar ("we", "our", or "us"). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website Ai Rojgar.ai and use our services. Please read this policy carefully. If you disagree with its terms, please discontinue use of our platform.' },
          ...
          { title: '9. Contact Us', content: 'If you have any questions about this Privacy Policy, please contact us at: Email: airojgar8@gmail.com | Phone: +91 9335203841 | Address: Varanasi, Uttar Pradesh, India — 221001.' },
        ].map(section => (
