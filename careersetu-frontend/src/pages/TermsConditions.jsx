    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '48px 20px', maxWidth: 860 }}>
        {[
          ...
          { title: '9. Contact', content: 'For questions about these Terms, contact us at: Email: airojgar8@gmail.com | Phone: +91 9335203841 | Address: Varanasi, Uttar Pradesh, India.' },
        ].map(section => (
