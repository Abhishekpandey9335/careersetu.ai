  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '48px 20px', maxWidth: 860 }}>
        {[
          { title: '1. Overview', content: 'At Ai Rojgar, we strive to provide the best possible experience for our users. This Refund Policy outlines the conditions under which refunds may be issued for premium subscription purchases. Please read this policy carefully before making any purchase.' },
          ...
          { title: '5. How to Request a Refund', content: 'To request a refund, please contact us within 7 days of purchase: Email: airojgar8@gmail.com | Subject: Refund Request — [Your Name] | Include: Your registered email, order/transaction ID, and reason for refund. We will process your request within 5–7 business days.' },
          { title: '6. Refund Processing', content: 'Approved refunds will be credited back to the original payment method within 7–10 business days, depending on your bank or payment provider. Ai Rojgar is not responsible for delays caused by banking institutions. You will receive an email confirmation once your refund has been processed.' },
          { title: '7. Contact Us', content: 'For any refund-related queries, contact us at: Email: airojgar8@gmail.com | Phone: +91 9335203841 | Working Hours: Monday to Saturday, 9:00 AM – 6:00 PM IST.' },
        ].map(section => (
